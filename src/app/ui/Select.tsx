...
export default function Select({
  ...
  return (
    <div>
      <label
        ref={labelRef}
        className={`label-select relative flex w-64 cursor-pointer items-center justify-between rounded-md border border-neutral-700 bg-[rgba(22,_23,_29,_0.5019607843)] bg-opacity-50 p-3 text-white ${className ?? ""}`}
        onClick={appear}
      >
        ...
        <div
          ref={menuRef}
          className="absolute left-0 top-16 z-[1] hidden max-h-64 w-full animate-appear overflow-y-auto border border-neutral-700 bg-[#1b1d21] transition-all duration-300 ease-in-out"
        >
